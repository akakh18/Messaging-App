...
class UserSearchAdapter(var profiles: List<UserProfile>, var activity: UserSearchActivity): RecyclerView.Adapter<UserSearchItemViewHolder>() {
...
class UserSearchItemViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
    fun bind(profile: UserProfile, activity: UserSearchActivity) {
